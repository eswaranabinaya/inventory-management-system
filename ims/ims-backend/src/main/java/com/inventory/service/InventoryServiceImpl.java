...
public class InventoryServiceImpl implements InventoryService {
    ...
    public InventoryServiceImpl(InventoryRepository inventoryRepository, ProductRepository productRepository, WarehouseRepository warehouseRepository, StockAlertService stockAlertService) {
